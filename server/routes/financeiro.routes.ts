  ...
  app.get('/api/financeiro/lancamentos', requireAuth, requireSensitiveUnlock, async (req, res) => {
    try {
      ...
      const filters = {
        ...
        projetoId: req.query.projetoId ? parseInt(req.query.projetoId as string) : undefined,
        campanhaId: req.query.campanhaId ? parseInt(req.query.campanhaId as string) : undefined,
