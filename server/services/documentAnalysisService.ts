...
TIPO DE DOCUMENTO: Classifique pelo conteúdo real usando os valores exatos abaixo:
Estudos e Relatórios Ambientais:
- EIA (Estudo de Impacto Ambiental) → "eia"
- RIMA (Relatório de Impacto ao Meio Ambiente) → "rima"
- RAS (Relatório Ambiental Simplificado) → "ras"
- RAP (Relatório Ambiental Preliminar) → "rap"
- PRAD (Projeto de Recuperação de Áreas Degradadas) → "prad"
- PCA (Plano de Controle Ambiental) → "pca"
- PBA (Plano Básico Ambiental) → "pba"
- PGAS (Plano de Gestão Ambiental e Social) → "pgas"
- PEE (Plano de Educação Ambiental) → "pee"
- PGRS (Plano de Gerenciamento de Resíduos Sólidos) → "pgrs"
- PCPV (Programa de Controle de Poeiras e Vibrações) → "pcpv"
Licenças Ambientais:
- LP (Licença Prévia) → "licenca_previa"
- LI (Licença de Instalação) → "licenca_instalacao"
- LO (Licença de Operação) → "licenca_operacao"
- LAS (Licença Ambiental Simplificada) → "las"
- Outras licenças ambientais → "licenca"
Comunicação Oficial:
...
- Termo (de referência, de adequação, de ajuste) → "termo"
Documentos Técnicos:
- ART/RRT → "art"
- Relatório Técnico genérico → "relatorio"
...

{
  ...
  "tipoDocumento": "eia|rima|ras|rap|prad|pca|pba|pgas|pee|pgrs|pcpv|licenca_previa|licenca_instalacao|licenca_operacao|las|licenca|oficio|notificacao|parecer|auto_infracao|termo|art|relatorio|mapa|documento_legal|condicionante|artigo_cientifico|outro",
