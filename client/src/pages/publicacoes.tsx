          ...
          <form onSubmit={form.handleSubmit(d => mutation.mutate(d))} className="space-y-4">
            ...
            <FormField control={form.control} name="autores" render={({ field }) => (
              <FormItem>
                ...
                <FormControl><Input {...field} placeholder="Silva, J.A.; Souza, M.B.; Maurivan Vaz Ribeiro" /></FormControl>
                <FormMessage />
              </FormItem>
            )} />
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            Artigos, capítulos e trabalhos com afiliação Maurivan Vaz Ribeiro
          </p>
        </div>
